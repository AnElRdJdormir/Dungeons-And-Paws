...
export function Modelos3D(scene, manager) {
 ...
 mtlpiso.load('models/Nivel2/PisoN2.mtl', function (materials) {
     materials.preload();
     loaderpiso.setMaterials(materials);
     loaderpiso.load('models/Nivel2/PisoN2.obj', function (object) {
         object.name = "Piso";
 ...
 mtlpared1.load('models/Nivel2/Pared1.mtl', function (materials) {
     materials.preload();
     loaderpared1.setMaterials(materials);
     loaderpared1.load('models/Nivel2/Pared1.obj', function (object) {
         object.name = "Pared1";
         object.scale.copy (new THREE.Vector3(2,2,2));
         object.position.set(-2.3, 1, 0);
         objParedDer = object;
         scene.add(object);
     });
 });
 ...
 mtlpared1.load('models/Nivel2/Pared2.mtl', function (materials) {
     materials.preload();
     loaderpared3.setMaterials(materials);
     loaderpared3.load('models/Nivel2/Pared2.obj', function (object) {
 ...
 mtlpared2.load('models/Nivel2/Pared3.mtl', function (materials) {
     materials.preload();
     loaderpared2.setMaterials(materials);
     loaderpared2.load('models/Nivel2/Pared3.obj', function (object) {
         object.name = "Pared2";
         object.scale.copy (new THREE.Vector3(2,2,2));
 ...
 mtlpared4.load('models/Nivel2/Pared4.mtl', function (materials) {
     materials.preload();
     loaderpared4.setMaterials(materials);
     loaderpared4.load('models/Nivel2/Pared4.obj', function (object) {
 ...
 mtltecho.load('models/Nivel2/Pared5.mtl', function (materials) {
     materials.preload();
     loadertecho.setMaterials(materials);
     loadertecho.load('models/Nivel2/Pared5.obj', function (object) {
         object.name = "Techo1";
         object.scale.copy (new THREE.Vector3(2,2,2));
         object.position.set(2.3, 1, 0);
 ...
 mtltecho2.load('models/Nivel2/Pared6.mtl', function (materials) {
     materials.preload();
     loadertecho2.setMaterials(materials);
     loadertecho2.load('models/Nivel2/Pared6.obj', function (object) {
         object.name = "Techo2";
         object.scale.copy (new THREE.Vector3(2,2,2));
         object.position.set(2.3, 1, 0);
